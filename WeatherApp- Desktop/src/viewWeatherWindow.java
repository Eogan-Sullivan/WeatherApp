...
public class viewWeatherWindow extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					viewWeatherWindow frame = new viewWeatherWindow();
	...
	public viewWeatherWindow() {
		...
		txtEnterTowncityHere.setBounds(20, 21, 182, 20);
